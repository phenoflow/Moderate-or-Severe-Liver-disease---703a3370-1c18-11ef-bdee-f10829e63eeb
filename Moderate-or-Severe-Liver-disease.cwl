...
steps:
  ...
  endoscopic-moderate-or-severe-liver-disease---primary:
    run: endoscopic-moderate-or-severe-liver-disease---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  moderate-or-severe-liver-disease-banding---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: endoscopic-moderate-or-severe-liver-disease---primary/output
